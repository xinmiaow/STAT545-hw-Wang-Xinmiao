...
![The Bar Chart of Continent](./hw07/barchart.png)

Here is the Histogram of lifeExp.

![The Histogram of LifeExp](./hw07/histogram.png)
...
![The Plot of LifeExp over Years in Each Continent](./hw07/timeplot_lifeExp.png)
...
![The Plot of Mean of LifeExp over Years in Each Continent](./hw07/timeplot_meanLifeExp.png)
...
![The Scatterplot of LifeExp over Years in Africa](./hw07/Africa.png)

The Scatterplot of LifeExp over Years in Asia

![The Scatterplot of LifeExp over Years in Asia](./hw07/Asia.png)

The Scatterplot of LifeExp over Years in Americas

![The Scatterplot of LifeExp over Years in Americas](./hw07/Americas.png)

The Scatterplot of LifeExp over Years in Europe

![The Scatterplot of LifeExp over Years in Europe](./hw07/Europe.png)

The Scatterplot of LifeExp over Years in Oceania

![The Scatterplot of LifeExp over Years in Oceania](./hw07/Oceania.png)
